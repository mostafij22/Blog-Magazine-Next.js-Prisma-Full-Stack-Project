        ...
        <div className="container section-top">
            <div className="row">
                    ...
                    <Carousel id="carouselHero" activeIndex={index} onSelect={handleSelect} controls={false}>
                        {
                            props.slider.map((item,i)=>{
                                return(
                                    <Carousel.Item>
                                        <Link  href={"/Details/"+item['title']+"?id="+item['id']}>
                                            <img className="w-100" src={item['img1']} text="First slide" />
                ...
                <div className="col-md-4 col-lg-4 col-sm-6 p-1 col-6">
                    <Link href={"/Details/"+props.featured[0]['title']+"?id="+props.featured[0]['id']} id='Hero' className="card h-100">
                        <img className="card-img-top w-100 rounded-2" src={props.featured[0]['img2']}/>
