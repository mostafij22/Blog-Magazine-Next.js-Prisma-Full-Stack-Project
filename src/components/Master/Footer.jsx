                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-6 p-3">
                                <h5 className="text-white fw-bold my-3">RECOMMENDED</h5>
                                {
                                    props.data['categories'].map((Item,i)=>{
                                       if(i<4){
                                           return (
                                               <Link key={i} className="nav-link text-white my-1" href={"/News/"+Item['name']+"?id="+Item['id']} >{Item['name']}</Link>
                                           )
                                       }
                                    })
                                }
                            ...
                            <div className="col-md-3 col-sm-6 p-3">
                                ...
                                <input value={data.email} onChange={(e)=>{inputOnChange("email",e.target.value)}} type="email" className="form-control w-100" placeholder="Email Address"/>
